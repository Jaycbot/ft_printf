...
/*   Updated: 2021/01/20 23:04:35 by jaehchoi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static int	utf_8_4(wchar_t unicode)
{
	unsigned char	unit;
...
static int	utf_8_3(wchar_t unicode)
{
	unsigned char	unit;
...
static int	utf_8_2(wchar_t unicode)
{
	unsigned char	unit;
...
static int	utf_8_1(wchar_t unicode)
{
	unsigned char	unit;
